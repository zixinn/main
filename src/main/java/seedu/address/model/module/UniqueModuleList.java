 ...
 * As such, adding and updating of modules uses Module#isSameModule(Module) for equality so as
 * to ensure that the module being added or updated is unique in terms of identity in the UniqueModuleList.
 * However, the removal of a module uses Module#equals(Object) so as to ensure that the module
...
public class UniqueModuleList implements Iterable<Module> {
     ...
     * {@code modules} must not contain duplicate module.
     */
