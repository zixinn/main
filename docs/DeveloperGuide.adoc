...
image::ModuleCiewSequenceDiagram.png[]
...
.. Test case: `delete 1` +
   Expected: First facilitator is deleted from the list. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.
.. Test case: `delete 0` +
