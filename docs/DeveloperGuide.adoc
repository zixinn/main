...
** 2b2. Mod Manager requests for the correct data.
+
Use case resumes at step 2.
...
[discrete]
=== Use case: UC03 - Edit module

*<<mss, MSS>>*

1.  User requests to edit a module.
2.  User provides the module code.
3.  User provides the new description.
...
* 3a. The new description is more than 60 characters.
+
[none]
** 3a1. Mod Manager shows an error message.
** 3a2. Mod Manager requests for the correct data.
+
Use case resumes at step 3.

[discrete]
=== Use case: UC04 - Delete module
...
[discrete]
=== Use case: UC014 - Add facilitator
...
[discrete]
=== Use case: UC15 - View facilitators

*<<mss, MSS>>*

1.  User requests to view facilitators.
...
[discrete]
=== Use case: UC16 - Find facilitator
...
[discrete]
=== Use case: UC17 - Edit facilitator

*<<mss, MSS>>*

1.  User requests to edit a facilitator.
2.  User provides the facilitator’s name.
...
[none]
* 2a. The given facilitator name is invalid.
+
[none]
** 2a1. Mod Manager shows an error message.
** 2a2. Mod Manager requests for the correct data.
...
[discrete]
=== Use case: UC18 - Delete facilitator

*<<mss, MSS>>*

1.  User requests to delete a facilitator.
2.  User provides the facilitator name.
...
** 1a2. Mod Manager requests for correct input.
+
Use case resumes at step 1.

[discrete]
=== Use case: UC20 - Find empty slots in calendar
*<<mss, MSS>>*
