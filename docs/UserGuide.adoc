...
Shows you the calendar for the current week.

It displays the tasks and classes you have in the current week.
The command will bring you automatically to the Calendar tab if you are in another tab.

Format: `cal view /week this`

==== Viewing calendar for next week

Shows you the calendar for next week.

It displays the tasks and classes you have in next week.
The command will bring you automatically to the Calendar tab if you are in another tab.
...
The list of empty slots will be displayed to you in the result display box.
The command will also bring you automatically to the Calendar tab if you are in another tab.

Format: `cal find empty`

Example: +
Suppose you want to find the empty slots in the calendar, but you are not in the Calendar tab:

1) You type the command.

image::CalFind1.png[]

2) Mod Manager brings you to the Calendar tab and lists to you the list of empty slots in the result display box.

image::CalFind2.png[]

The full message in the result display box in the above example is:
