...
Example: `facil edit 1 /name Akshay /email hisnewemail@nus.edu.sg` or `facil edit Akshay Narayan /name Akshay /email hisnewemail@nus.edu.sg`
...
Example: `facil delete 2` or `facil delete Akshay Narayan`
...
or `*facil* edit FACILITATOR_NAME [/name FACILITATOR_NAME] [/email EMAIL] [/phone PHONE] [/office OFFICE] [/code MOD_CODE...]`
|  `*facil* delete INDEX` or `*facil* delete FACILITATOR_NAME`
