...
You can also remove the description of a module without specifying any input after the prefix.
...
You can also remove the information of a facilitator without specifying any input after the prefix.
