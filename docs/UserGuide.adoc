...
Examples: To find tasks that contain the word `oral`, `assign`, or `tut` in their description,
...
Example: You can search for tasks that are due on the submission date of CS2103T for AY19/20 S2
...
==== Individual view of the recently edited element after an `add`, `edit` or `delete` command `[coming in v2.0]`
