...
Format: `*task* edit MOD_CODE TASK_ID_NUMBER [/desc DESCRIPTION] [/on DATE/non] [/at TIME]`
...
|  `*task* delete MOD_CODE TASK_ID_NUMBER`
|  `*task* edit MOD_CODE TASK_ID_NUMBER [/desc DESCRIPTION] [/on DATE/non] [/at TIME]`
