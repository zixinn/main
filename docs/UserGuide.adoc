...
Deletes the class from the module. Selects a class to be deleted by its index in the displayed module's class list. You can view the module's class list by using `*mod* view MOD_CODE` as stated in section 3.2.3.
...
You can clear all entries from Mod Manager.
