...
.6+|Task
| `*task* add /code MOD_CODE /desc TASK_NAME {[/by DATE TIME] [/at DATE TIME]}`
| `*task* list`
| `*task* find [/date DATE] [/month MONTH] [/year YEAR]`
| `*task* find /upcoming`
| `*task* find /desc TASK_NAME`
| `*task* edit /code MOD_CODE /desc TASK_NAME {[/by DATE TIME] [/at DATE TIME]}`
