...
|=====
^|*Symbol* |*Meaning*
^|Enter | The enter button on the keyboard.
...
=======
The command groups available in Mod Manager are the words in bold you have seen throughout this document.
>>>>>>> 9064f36b0133a117928cfd0f0493cffbdca3a969
...
==== Navigating through past commands with up/down key
...
<<Viewing all tasks across all modules in ModManger, `*task* list`>>,
or the task list of a specific module - can be viewed with <<Viewing information of a module, `*mod* view`>>.
****
...
The properties of `DESCRIPTION`, `DATE` and `TIME` are described in the <<Adding a task, adding a task>> section.
...
the sorting property of the <<Viewing all tasks across all modules in ModManger, task list>>.
...
==== Viewing all tasks across all modules
...
The tasks will be automatically sorted by time for you: tasks with nearer date will be prioritized, and tasks without
date and time will be at the end.
...
By typing the command above and hit Enter, you should only see uncompleted tasks,
