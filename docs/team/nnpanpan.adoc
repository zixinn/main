...
** Documentation:
*** Wrote the task edit/delete and undo/redo sections of the User Guide: https://github.com/AY1920S2-CS2103T-F10-4/main/pull/135[#135], https://github.com/AY1920S2-CS2103T-F10-4/main/pull/196[#196]
