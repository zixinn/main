...
** Documentation:
*** Added the task edit/delete sections of the User Guide: https://github.com/AY1920S2-CS2103T-F10-4/main/pull/135[#135]
** Community:
...
== Overview of `Task`
include::../DeveloperGuide.adoc[tag=taskOverview]
