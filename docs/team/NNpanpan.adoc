...
** Documentation:
*** Wrote the task edit/delete and undo/redo sections of the User Guide: https://github.com/AY1920S2-CS2103T-F10-4/main/pull/135[#135]
*** Wrote the general features and task edit/delete sections of the Developer Guide:
** Community:
...
== `task edit` and `task delete` commands
